...
setInterval(function(){
   ...
   else if (mySrc === 'images/logo12.jpg')
   {
       mypiclogo.setAttribute('src','images/logo13.jpg');

   }

   else if (mySrc === 'images/logo13.jpg')
   {
       mypiclogo.setAttribute('src','images/logo14.jpg');
